...
exports.listTransactions = exports.createTransaction = exports.getInsights = exports.getPriceHistory = exports.getPrices = exports.getCrops = void 0;
...
const getPrices = async (req, res) => {
    try {
        ...
        if (district)
            cacheKey.district = district;
        const cached = await MarketPrice_1.default.find({
            ...cacheKey,
        ...
        const fused = await (0, scraperService_1.scrapePrice)(commodity, state);
        if (fused) {
            const now = new Date();
            // Create a single summary record with the fused price
            const record = await MarketPrice_1.default.create({
                state,
                district: district || '',
