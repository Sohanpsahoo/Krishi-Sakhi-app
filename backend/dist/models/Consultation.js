...
const consultationSchema = new mongoose_1.Schema({
    farmer: { type: mongoose_1.default.Schema.Types.ObjectId, ref: 'Farmer', required: true },
    officer: { type: mongoose_1.default.Schema.Types.ObjectId, ref: 'Officer', required: true },
