...
// ---------------------------------------------------------------------------
async function getGeminiExplanation({ modelContext, farmerName, userState, userDistrict, irrigationType, landSizeAcres }: any): Promise<any> {
...
Respond ONLY with this exact JSON (no markdown fences):
{
  ...
  // Bypassing Gemini per user request to provide INSTANT raw ML recommendations using the high-quality weather-aware fallback.
