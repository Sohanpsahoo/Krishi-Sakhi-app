...
// Consultant routes don't show the farmer sidebar/nav
...
export default function App() {
  ...
  const isConsultantRoute = CONSULTANT_ROUTES.includes(route);
  ...
  return (
    <LanguageProvider>
      {page}
      {/* Only show farmer mobile nav on farmer routes */}
      {!isConsultantRoute && <MobileNav />}
    </LanguageProvider>
  );
}
